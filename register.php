...
<head>
    ...
    .nav-btn{
        color: blue; background-color: white; padding-left: 20px; padding-right: 20px; font-family: serif; border-style: none; font-size: 30px;
    }

    .register-h{
        color: white; font-family: serif; font-weight: bolder;
    }
    </style>
...
<body>
    <div class="nav">
        <ul>
            <li><a href="#"> <button type="button" name="add" id="add" data-toggle="modal" data-target="#signup1" class="btn nav-btn" >Sign Up</button> </a></li>
            <li><a href="#"><button type="button" name="add" id="add" data-toggle="modal" data-target="#login1" class="btn nav-btn" >Login</button></a></li>
        </ul>
        <h1 style="font-size: 35px;" class="register-h"><i>Find Your Accommodation </i></h1><br><br><br><br><br><br>
        <p style="font-size: 45px;" class="register-h">Are you a student in search of good accommodation in Nairobi? <br> Join us today, finding a good hostel is a click away...</p>
    </div>
