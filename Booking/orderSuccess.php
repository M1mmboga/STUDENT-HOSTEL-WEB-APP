...
$query = $conn->query("SELECT * FROM booking WHERE bookingid=(SELECT MAX(bookingid) FROM booking)");
...
$first_name = 'Miriam';//$_POST['firstname'];
$last_name =  'Mmboga';//$_POST['lastname'];
$email = 'mmbogamiriam2@gmail.com';//$_POST['email'];
...
<div class="container">
    ...
    <p>Your booking has submitted successfully. Booking ID is #<?php echo $_GET['id']; ?><a href="../homepage1.php">Back to home page</a></p>
</div>
